...
#################################################################
# AWS Resource Lister
# A Bash script to list AWS resources across multiple services

# Usage: ./aws_resource_list.sh <aws_region> <aws_service>
# Example: ./aws_resource_list.sh us-east-1 ec2

# Supported Services:
# ec2, rds, s3, cloudfront, vpc, iam, route53,
# cloudwatch, cloudformation, lambda, sns, sqs,
# dynamodb, ebs, all
################################################################
...
if ! command -v aws &>/dev/null; then
       echo "AWS CLI not installed. Install it: https://docs.aws.amazon.com/cli/" 
       exit 1
fi
